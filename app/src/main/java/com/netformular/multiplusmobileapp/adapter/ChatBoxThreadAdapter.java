...
public class ChatBoxThreadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static String TAG = ChatBoxThreadAdapter.class.getSimpleName();
    ...
    public ChatBoxThreadAdapter(Context mContext, ArrayList<Message> messageArrayList, String userId) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (message.getUser().getFirstname() != null)
